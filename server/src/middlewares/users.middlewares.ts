...
export const confirm_password: ParamSchema = {
  notEmpty: {
...
export const forgot_password_token: ParamSchema = {
  trim: true,
  custom: {
...
export const verifyValidator = (req: Request, res: Response, next: NextFunction) => {
